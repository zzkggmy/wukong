...
.method public sendRequest(Landroid/app/Activity;Lcom/sina/weibo/sdk/api/share/BaseRequest;)Z
    ...
    const-string v3, "sendRequest faild request is null"
    ...
    :cond_1
    :try_start_0
    iget-boolean v2, p0, Lcom/sina/weibo/sdk/api/share/WeiboShareAPIImpl;->mNeedDownloadWeibo:Z

    invoke-direct {p0, v2}, Lcom/sina/weibo/sdk/api/share/WeiboShareAPIImpl;->checkEnvironment(Z)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    new-instance v4, Lcom/sina/weibo/sdk/api/share/VersionCheckHandler;

    invoke-direct {v4}, Lcom/sina/weibo/sdk/api/share/VersionCheckHandler;-><init>()V

    invoke-virtual {p2, v2, v3, v4}, Lcom/sina/weibo/sdk/api/share/BaseRequest;->check(Landroid/content/Context;Lcom/sina/weibo/sdk/WeiboAppManager$WeiboInfo;Lcom/sina/weibo/sdk/api/share/VersionCheckHandler;)Z
    ...
    const-string v3, "sendRequest faild request check faild"
    ...
    invoke-static {v2, v3}, Lcom/sina/weibo/sdk/cmd/WbAppActivator;->getInstance(Landroid/content/Context;Ljava/lang/String;)Lcom/sina/weibo/sdk/cmd/WbAppActivator;

    move-result-object v2

    invoke-virtual {v2}, Lcom/sina/weibo/sdk/cmd/WbAppActivator;->activateApp()V
    ...
    invoke-virtual {p2, v6}, Lcom/sina/weibo/sdk/api/share/BaseRequest;->toBundle(Landroid/os/Bundle;)V

    .line 313
    instance-of v2, p2, Lcom/sina/weibo/sdk/api/share/SendMultiMessageToWeiboRequest;
    ...
    .line 316
    .local v10, "multiMessageRequest":Lcom/sina/weibo/sdk/api/share/SendMultiMessageToWeiboRequest;
    iget-object v2, v10, Lcom/sina/weibo/sdk/api/share/SendMultiMessageToWeiboRequest;->multiMessage:Lcom/sina/weibo/sdk/api/WeiboMultiMessage;
    ...
    invoke-virtual {v2}, Lcom/sina/weibo/sdk/api/WeiboMultiMessage;->getMsgType()I
    ...
    .end local v10    # "multiMessageRequest":Lcom/sina/weibo/sdk/api/share/SendMultiMessageToWeiboRequest;
    :cond_3
    ...
    invoke-direct/range {v1 .. v7}, Lcom/sina/weibo/sdk/api/share/WeiboShareAPIImpl;->launchWeiboActivity(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;)Z
