.class public Lno/nordicsemi/android/support/v18/scanner/ScanRecord;
...
.method private constructor <init>(Ljava/util/List;Landroid/util/SparseArray;Ljava/util/Map;IILjava/lang/String;[B)V
    ...
    .line 157
    iput-object p1, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mServiceUuids:Ljava/util/List;

    .line 158
    iput-object p2, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mManufacturerSpecificData:Landroid/util/SparseArray;

    .line 159
    iput-object p3, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mServiceData:Ljava/util/Map;

    .line 160
    iput-object p6, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mDeviceName:Ljava/lang/String;

    .line 161
    iput p4, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mAdvertiseFlags:I

    .line 162
    iput p5, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mTxPowerLevel:I

    .line 163
    iput-object p7, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mBytes:[B
...
.method static parseFromBytes([B)Lno/nordicsemi/android/support/v18/scanner/ScanRecord;
    ...
    .line 259
    :cond_1
    new-instance v3, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;

    move-object/from16 v10, p0

    invoke-direct/range {v3 .. v10}, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;-><init>(Ljava/util/List;Landroid/util/SparseArray;Ljava/util/Map;IILjava/lang/String;[B)V
    :try_end_1
    ...
    .line 265
    new-instance v10, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;
    ...
    invoke-direct/range {v10 .. v17}, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;-><init>(Ljava/util/List;Landroid/util/SparseArray;Ljava/util/Map;IILjava/lang/String;[B)V
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->parseServiceUuid([BIIILjava/util/List;)I
    ...
    invoke-static {v0, v1, v2}, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->extractBytes([BII)[B
    ...
    invoke-static/range {v28 .. v28}, Lno/nordicsemi/android/support/v18/scanner/BluetoothUuid;->parseUuidFrom([B)Landroid/os/ParcelUuid;
    ...
    invoke-static {v0, v3, v10}, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->extractBytes([BII)[B
...
.method public getAdvertiseFlags()I
    ...
    .prologue
    .line 79
    iget v0, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mAdvertiseFlags:I
...
.method public getBytes()[B
    ...
    .prologue
    .line 149
    iget-object v0, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mBytes:[B
...
.method public getDeviceName()Ljava/lang/String;
    ...
    .prologue
    .line 142
    iget-object v0, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mDeviceName:Ljava/lang/String;
...
.method public getManufacturerSpecificData()Landroid/util/SparseArray;
    ...
    .prologue
    .line 95
    iget-object v0, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mManufacturerSpecificData:Landroid/util/SparseArray;
...
.method public getServiceData()Ljava/util/Map;
    ...
    .prologue
    .line 111
    iget-object v0, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mServiceData:Ljava/util/Map;
...
.method public getServiceUuids()Ljava/util/List;
    ...
    .prologue
    .line 87
    iget-object v0, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mServiceUuids:Ljava/util/List;
...
.method public getTxPowerLevel()I
    ...
    .prologue
    .line 134
    iget v0, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mTxPowerLevel:I
...
.method public toString()Ljava/lang/String;
    ...
    iget v1, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mAdvertiseFlags:I
    ...
    iget-object v1, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mServiceUuids:Ljava/util/List;
    ...
    iget-object v1, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mManufacturerSpecificData:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mServiceData:Ljava/util/Map;
    ...
    iget v1, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mTxPowerLevel:I
    ...
    iget-object v1, p0, Lno/nordicsemi/android/support/v18/scanner/ScanRecord;->mDeviceName:Ljava/lang/String;
