...
.method protected getXLabels(DDI)Ljava/util/List;
    ...
    iget-object v15, v0, Lorg/achartengine/chart/TimeChart;->mRenderer:Lorg/achartengine/renderer/XYMultipleSeriesRenderer;

    invoke-virtual {v15}, Lorg/achartengine/renderer/XYMultipleSeriesRenderer;->isXRoundedLabels()Z
    ...
    iget-object v15, v0, Lorg/achartengine/chart/TimeChart;->mDataset:Lorg/achartengine/model/XYMultipleSeriesDataset;

    invoke-virtual {v15}, Lorg/achartengine/model/XYMultipleSeriesDataset;->getSeriesCount()I
    ...
    invoke-virtual {v15, v0}, Lorg/achartengine/model/XYMultipleSeriesDataset;->getSeriesAt(I)Lorg/achartengine/model/XYSeries;
    ...
    .line 166
    .local v18, "value":D
    cmpg-double v15, p1, v18

    if-gtz v15, :cond_0

    cmpg-double v15, v18, p3
    ...
    invoke-virtual {v12, v15}, Lorg/achartengine/model/XYSeries;->getX(I)D
    ...
    iget-object v15, v0, Lorg/achartengine/chart/TimeChart;->mStartPoint:Ljava/lang/Double;
    ...
    rem-double v20, p1, v20

    sub-double v20, p1, v20
    ...
    invoke-virtual {v15}, Ljava/util/Date;->getTimezoneOffset()I
    ...
    iput-object v15, v0, Lorg/achartengine/chart/TimeChart;->mStartPoint:Ljava/lang/Double;
