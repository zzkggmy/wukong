...
.method public draw(Landroid/graphics/Canvas;IIIILandroid/graphics/Paint;)V
    ...
    .line 218
    aget-wide v4, v88, v21

    aget-wide v10, v94, v21
    ...
    aget-wide v10, v88, v21

    aget-wide v16, v94, v21

    sub-double v10, v10, v16

    div-double/2addr v4, v10

    aput-wide v4, v111, v21

    .line 221
    :cond_16
    aget-wide v4, v89, v21

    aget-wide v10, v53, v21
    ...
    aget-wide v10, v89, v21

    aget-wide v16, v53, v21
    ...
    .line 247
    .local v25, "points":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Float;>;"
    new-instance v26, Ljava/util/ArrayList;

    invoke-direct/range {v26 .. v26}, Ljava/util/ArrayList;-><init>()V

    .line 248
    .local v26, "values":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Double;>;"
    move/from16 v0, v37
    ...
    aget-wide v16, v52, v103

    aget-wide v18, v53, v103
    ...
    .line 254
    :try_start_0
    aget-wide v16, v94, v103

    aget-wide v18, v88, v103
    ...
    .line 256
    .local v95, "range":Ljava/util/SortedMap;, "Ljava/util/SortedMap<Ljava/lang/Double;Ljava/lang/Double;>;"
    const/16 v23, -0x1

    .line 258
    .local v23, "startIndex":I
    invoke-interface/range {v95 .. v95}, Ljava/util/SortedMap;->entrySet()Ljava/util/Set;
    ...
    aget-wide v16, v53, v103

    sub-double v16, v116, v16
    ...
    .end local v95    # "range":Ljava/util/SortedMap;, "Ljava/util/SortedMap<Ljava/lang/Double;Ljava/lang/Double;>;"
    ...
    .restart local v95    # "range":Ljava/util/SortedMap;, "Ljava/util/SortedMap<Ljava/lang/Double;Ljava/lang/Double;>;"
    ...
    .end local v15    # "series":Lorg/achartengine/model/XYSeries;
    .end local v23    # "startIndex":I
    .end local v25    # "points":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Float;>;"
    .end local v26    # "values":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Double;>;"
    ...
    aget-wide v40, v94, v4

    const/4 v4, 0x0

    aget-wide v42, v88, v4
    ...
    invoke-virtual/range {v39 .. v44}, Lorg/achartengine/chart/XYChart;->getXLabels(DDI)Ljava/util/List;
    ...
    aget-wide v10, v52, v21

    invoke-virtual/range {v85 .. v85}, Ljava/lang/Double;->doubleValue()D

    move-result-wide v16

    aget-wide v18, v53, v21
...
.method protected drawChartValuesText(Landroid/graphics/Canvas;Lorg/achartengine/model/XYSeries;Lorg/achartengine/renderer/SimpleSeriesRenderer;Landroid/graphics/Paint;Ljava/util/List;II)V
    ...
    invoke-virtual {p0, v2, v4, v5}, Lorg/achartengine/chart/XYChart;->getLabel(Ljava/text/NumberFormat;D)Ljava/lang/String;
...
.method protected drawXLabels(Ljava/util/List;[Ljava/lang/Double;Landroid/graphics/Canvas;Landroid/graphics/Paint;IIIDDD)V
    ...
    invoke-virtual {v0, v4, v1, v2}, Lorg/achartengine/chart/XYChart;->getLabel(Ljava/text/NumberFormat;D)Ljava/lang/String;
